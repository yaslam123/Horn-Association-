...
export default function About() {
  ...
  const [aboutContent, setAboutContent] = useState({
    ...
    sectionTitleText: "welcome to Horn Associates",
    sectionMainTitle: "Committed to Excellence in Legal Representation",
    aboutText:
      "At Horn Associates, we believe in justice, integrity, and strategic legal advocacy. With decades of experience, we have built a reputation for delivering high-quality legal solutions across corporate, energy, investment, and maritime sectors. Our deep understanding of Somalia’s legal landscape ensures that businesses and investors can operate with confidence and security.",
    learnMoreLink: "/about",
    signatureImage: "/assets/img/about/signature1.png",
    ceoName: "Yaslam Osman, CEO",
